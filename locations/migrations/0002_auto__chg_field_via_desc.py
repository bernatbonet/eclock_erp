...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Via.desc'
        db.alter_column('locations_via', 'desc', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35))

    def backwards(self, orm):

        # Changing field 'Via.desc'
        db.alter_column('locations_via', 'desc', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
